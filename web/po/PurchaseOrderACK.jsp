                    ...
                    <div>
                        <table border-none:="0">
                            <tr>
                                ...
                                <td><div id="orderAck">ORDER </div><div id="orderAck1">Acknowledgement</div></td>
                            </tr>
                                    ...
                                    <s:form action="#" method="post" name="plsForm1" id="plsForm1" theme="simple">
                                        <table>                               
                                            <tr><td colspan="8">                                               
                                                ...
                                                <td width="50%">
                                                    <table border="0" class="invoice_fields">
                                                        <tr>
                                                            <td class="alignright" style=" background-color: #0174DF;"><font color="white">DATE</font></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="alignright"> <s:textfield name="date" id="date"/></td>

                                                        </tr>
                                                        <tr>
                                                            <td class="alignright" style="background:#0174DF;"><font color="white">PURCHASE&nbsp;ORDER&nbsp;NO.</font></td>
                                                        </tr>

                                                        <tr>
                                                            <td class="alignright"> <s:textfield name="purchaseordernum" id="purchaseordernum"/></td>
                                                        <tr>
                                                            <td class="alignright" style="background:#0174DF;"><font color="white">CUSTOMER&nbsp;NO.</font></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="alignright"><s:textfield name="customernum" id="customernum"/></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <div class="row">
                                                <table align="left" id="results" style="width:1114px;border-collapse: collapse;"
                                                    ...
                                                    <tr style="height:20px">
                                                        <th style="width: 25px;background:#0174DF">SHIP VIA</th>
                                                        <th style="width: 25px;background:#0174DF">SHIPPING METHOD</th>
                                                        <th style="width: 25px;background:#0174DF">SHIPPING TERMS</th>

                                                        <th style="width: 25px;background:#0174DF">PAYMENT</th>
                                                        <th style="width: 25px;background:#0174DF">DELIV.DATE</th>
                                            ...
                                            <div class="row">
                                                ...
                                                <table align="left" id="results" style="width:1114px;border-collapse: collapse;"
                                                    ...
                                                    <tr style="height:25px;width: 20px">
                                                        <th style="width: 25px;background:#0174DF">ITEMS</th>
                                            ...
                                            <table class="alignright1" style="width:406px;length:60px ; background:#CEECF5;margin-right:3.2cm;" border="1"  cellpadding="0" cellspacing="0" class="CSSTableGenerator">
                                                <tr height="25px">
                                            ...
                                            <div class="row">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <s:textarea name="logisticsLoadTenderingXml.ShipperInstructions" id="ShipperInstructions" style="text-align:center"  onchange="fieldLengthValidator(this);" cols="71" rows="6" wrap="true" tabindex="60" placeholder="Remarks/Instructions:"></s:textarea>
                                                        </td>
                                                    </tr>
                                                </table> 
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div> <s:textarea name="logisticsLoadTenderingXml.ShipperInstructions" id="ShipperInstructions"  onchange="fieldLengthValidator(this);" cols="40" rows="3" wrap="true" tabindex="60" style="color:#2E2EFE" placeholder="DATE"></s:textarea></div>
                                                            </td>


                                                            <td>
                                                                <div id="textareas"><s:textarea name="logisticsLoadTenderingXml.ShipperInstructions" id="ShipperInstructions"  onchange="fieldLengthValidator(this);" cols="49" rows="3" wrap="true" tabindex="60" style="color:#2E2EFE;margin-top:5px;" placeholder="AUTHORIZED SIGNATURE"></s:textarea></div>
